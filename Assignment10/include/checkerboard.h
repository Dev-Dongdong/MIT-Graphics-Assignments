 ...
 * @Description: 
 * @Author: LvBujing
 * @Date: 2021-10-17 21:11:39
 * @LastEditTime: 2021-10-17 21:11:51
 ...
 * @LastEditTime: 2021-10-17 21:10:44
 * @LastEditors: LvBujing
 */
...
public:
    ...
    Vec3f Shade(const Ray &ray, const Hit &hit, const Vec3f &dirToLight, 
     const Vec3f &lightColor, const float &distance, RayTracer* raytracer) {
        ...
        m->Transform(pos);
        if (matDistribute(pos)) return mat1->Shade(ray,hit,dirToLight,lightColor,distance, raytracer);
        else return mat2->Shade(ray,hit,dirToLight,lightColor,distance, raytracer);
    }
};
