 ...
 * @LastEditTime: 2021-01-06 16:38:09
...
Ray PerspectiveCamera::generateRay(Vec2f point){
    ...
    Vec3f base = virtualCenter - (size * screenUp) * 0.5f - (size * horizontal) * 0.5f;
    Vec3f offset = (size * horizontal) * point.x() + (size * screenUp) * point.y();
...
// Perspective Camera will only record the object in front of the center along the direction
