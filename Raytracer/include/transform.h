 ...
 * @LastEditTime: 2021-02-02 20:44:43
...
public:
    Transform(const Matrix &_matrix, Object3D* _obj): matrix(_matrix),obj(_obj){
        Vec3f minP ,maxP;
        this->Object3D::calculateBox(minP,maxP,obj->getBoundingBox(),&matrix);
        //cout<<"Before trans box: ";obj->getBoundingBox()->Print();
        box = new BoundingBox(minP,maxP);
        //cout<<"After trans box:  ";box->Print();
    }
    ~Transform(){}
...
void Transform::insertIntoGrid(Grid *g, Matrix *m){
    ...
    else newMatrix = new Matrix(*m * matrix);
    obj->insertIntoGrid(g,newMatrix);
}
