 ...
 * @Description: 
 * @Author: LvBujing
 * @Date: 2021-03-02 11:17:29
 * @LastEditTime: 2021-03-05 21:05:23
...
void Film::renderSamples(const char *samples_file, int sample_zoom) {
...
void Film::renderFilter(const char *filter_file, int filter_zoom, Filter *filter) {
