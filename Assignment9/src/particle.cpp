/*
 * @Description: A little comments
 * @Author: LvBujing
 * @Date: 2021-03-11 18:15:12
 * @LastEditTime: 2021-03-13 14:19:15
...
void Particle::increaseAge(float a) {   // Simply change particle's color
  // interpolate towards dead_color as the clock ticks down  
  float t = 1;
  if (timeToDeath > 0) 
    t = a / timeToDeath;
  if (t > 1) t = 1;
  color += t*(dead_color-color);  //  Interesting
