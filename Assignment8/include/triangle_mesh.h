/*
 * @Description: A little change to trianglemesh
 * @Author: LvBujing
 * @Date: 2021-03-09 10:50:29
 * @LastEditTime: 2021-03-10 19:45:42
...
public:
  ...
  // MODIFIERS
  //  No.i vertex's position
  void SetVertex(int i, Vec3f v) {
    assert (i >= 0 && i < num_vertices);
    vertices[i] = v; }
  //  No.i triangles three points' index
